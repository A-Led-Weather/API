...
class Router
{
    ...
    public function addRoute(string $requestMethod, string $route): array
    {
        ...
        $dispatcher = simpleDispatcher(function (RouteCollector $r) {
            $r->addRoute(self::GET_LAST_REPORTS['method'], self::GET_LAST_REPORTS['uri'], self::GET_LAST_REPORTS['request']);
            $r->addRoute(self::ADD_REPORT['method'], self::ADD_REPORT['uri'], self::ADD_REPORT['request']);
            $r->addRoute(self::GET_REPORT_BY_ID['method'], self::GET_REPORT_BY_ID['uri'], self::GET_REPORT_BY_ID['request']);
            $r->addRoute(self::DELETE_REPORT['method'], self::DELETE_REPORT['uri'], self::DELETE_REPORT['request']);
            $r->addRoute(self::GET_LAST_REPORT_BY_LOCATION['method'], self::GET_LAST_REPORT_BY_LOCATION['uri'], self::GET_LAST_REPORT_BY_LOCATION['request']);
            $r->addRoute(self::GET_REPORTS_BY_LOCATION_BY_TIME_RANGE['method'], self::GET_REPORTS_BY_LOCATION_BY_TIME_RANGE['uri'], self::GET_REPORTS_BY_LOCATION_BY_TIME_RANGE['request']);
            $r->addRoute(self::ADD_USER['method'], self::ADD_USER['uri'], self::ADD_USER['request']);
            $r->addRoute(self::GET_USER_BY_EMAIL['method'], self::GET_USER_BY_EMAIL['uri'], self::GET_USER_BY_EMAIL['request']);
            $r->addRoute(self::UPDATE_USER['method'], self::UPDATE_USER['uri'], self::UPDATE_USER['request']);
            $r->addRoute(self::DELETE_USER['method'], self::DELETE_USER['uri'], self::DELETE_USER['request']);
            $r->addRoute(self::AUTHENTICATE_USER['method'], self::AUTHENTICATE_USER['uri'], self::AUTHENTICATE_USER['request']);
        });
